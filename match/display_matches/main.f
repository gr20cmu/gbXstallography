C*****************************************
       program display_matches
C*****************************************
       implicit none
	   include 'common.fi'

       write(6,*) '================================================='
	   write(6,*) ' PROGRAM TO DISPLAY MATCHED TJ LINE SEGMENTS ON'
       write(6,*) ' EBSD MAPS '
	   write(6,*) ' '
       ...
       !version 06/17/2022: based on display_tjs, this version specifically for matches
